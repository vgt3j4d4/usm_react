...
import { ToolbarMapButtons } from "./ToolbarMapButtons";
import ToolbarNavButton from "./ToolbarNavButton";
import { ToolbarIterationsButtons } from "./ToolbarIterationsButtons";
  ...
  return (
    <div role="toolbar" className="sticky w-full flex justify-between items-center gap-2 p-2 bg-black text-white">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex gap-2">
        {isMappingView ? <ToolbarMapButtons /> : <ToolbarIterationsButtons />}
      </div>
